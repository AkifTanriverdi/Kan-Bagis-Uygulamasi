        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              if(bloodgroup.equals("Kan Grubunuzu Seçiniz")){
                  Toast.makeText(donorRegistrationActivity.this,"Kan Grubunuzu Seçiniz",Toast.LENGTH_LONG).show();
                  return;
              }

                if(citiesgroup.equals("Bulunduğunuz İli Seçiniz")){
                    Toast.makeText(donorRegistrationActivity.this," Bulunduğunuz İli Seçiniz",Toast.LENGTH_LONG).show();
                    return;
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(!task.isSuccessful()){
                                ...
                                Toast.makeText(donorRegistrationActivity.this,"Hata !"+eror,Toast.LENGTH_LONG).show();
                            }
                            else{
                                ...
                                //güncelleme yapacağın zaman ki 146.satır: userInfo.put("search","donor"+bloodgroup+citiesgroup); olacak
                                ...
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(donorRegistrationActivity.this,"Veri başarıyla kaydedildi",Toast.LENGTH_LONG).show();
                                        }
                                        else{
                                ...
                                if(resultUri!=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(donorRegistrationActivity.this,"Resim dosyası arızalı !",Toast.LENGTH_LONG).show();
                                        }
                                    });
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(donorRegistrationActivity.this,"Resim başarıyla eklendi",Toast.LENGTH_LONG).show();
                                                                }
                                                                else{
                                                                    Toast.makeText(donorRegistrationActivity.this,task.getException().toString(),Toast.LENGTH_LONG).show();
                                                                }
